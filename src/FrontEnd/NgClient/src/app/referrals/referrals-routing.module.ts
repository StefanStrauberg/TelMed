...
const routes: Routes = [
  ...
  { path: ':referralId/anamnesis/edit/:anamnesisCategoryId', component: UpdateAnamnesiesComponent },
  { path: ':referralId/purpose/edit/:purposeGroupId', component: UpdatePurposeComponent },
]
